...
for s in screenshots:
    ...
    if SAVEAS == 'jpg':
        ...
        fname = os.path.splitext(os.path.join(CROPPED_FOLDER, "crop_"+os.path.basename(s)))[0]+'.jpg'
        rgb_im.save(fname, format='JPEG', subsampling=2, quality=50)	#
    else:
        fname = os.path.splitext(os.path.join(CROPPED_FOLDER, "crop_"+os.path.basename(s)))[0]+'.png'
